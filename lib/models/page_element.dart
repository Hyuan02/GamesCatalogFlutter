class PageElement {
  ...
  PageElement.fromJson(Map<String, dynamic> json) {
    count = json['count'];
    next = json['next'];
...
class Results {
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.markets != null) {
      data['stores'] = this.markets.map((v) => v.toJson()).toList();
    }
    if (this.clip != null) {
...
class Markets {
  ...
  Markets({this.id, this.market, this.urlEn, this.urlRu});

  Markets.fromJson(Map<String, dynamic> json) {
    id = json['id'];
    market = json['store'] != null ? new Market.fromJson(json['store']) : null;
    urlEn = json['url_en'];
    urlRu = json['url_ru'];
  }
